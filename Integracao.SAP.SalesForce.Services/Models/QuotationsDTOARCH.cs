...
namespace Integracao.SAP.SalesForce.Services.Models
{
    ...
    public class QuotationsDTOARCH
    {
        ...
        public List<DocumentLineARCH> DocumentLines { get; set; }

        public TaxExtensionARCH TaxExtension { get; set; }
    }

    public class TaxExtensionARCH
    {
